...
*In this video example our hardware engineer Lasse has build is own version of the sensor, based on the schematics from [pulsesensor.com](http://pulsesensor.com)*
